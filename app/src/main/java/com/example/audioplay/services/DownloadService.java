...
import com.example.audioplay.MainActivity;
import com.example.audioplay.R;
...
public class DownloadService extends Service {
    ...
    // 用于绑定活动与服务。在这个例子中，返回一个 DownloadBinder 实例，该实例允许活动与服务进行通信。
    @Nullable
    @Override
    ...
    public class DownloadBinder extends Binder{
        ...
        public void startDownload(String url, String filename) {
            if (downloadTask == null) {
                downloadUrl = url;
                downloadTask = new DownloadTask(listener, filename, getApplicationContext());
